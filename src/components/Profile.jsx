    ...
    <div className="profile">
      ...
      <div className="profile_info">
        ...
        <div className="profile_location">
          ...
          <p><strong>Dimension:</strong> {origin?.dimension || 'Unknown'}</p>
          <p><strong>Residents:</strong> {origin?.residents ? origin?.residents.length : 'Unknown'}</p>
        </div>
        <div className="profile_location">
          <h3>Current Location</h3>
          <p><strong>Name:</strong> {character.location.name}</p>
          <p><strong>Dimension:</strong> {location?.dimension || 'Unknown'}</p>
          <p><strong>Residents:</strong> {location?.residents ? location?.residents.length : 'Unknown'}</p>
        </div>
